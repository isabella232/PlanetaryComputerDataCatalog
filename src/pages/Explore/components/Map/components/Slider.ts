...
export class SwipeMap extends azmaps.internal.EventEmitter<SwipeMapEvents> {
    ...
    public dispose(): void {
        ...
        self._options = null as any;

        //Remove swipe map container.
        self._primaryMap.getMapContainer().removeChild(self._container);
        self._container = null as any;
        self._swipeHandle = null as any;

        self._secondaryMap = null as any;
        self._rightMapClientRect = null as any;

        self._primaryMap = null as any;
    }
    ...
    */
    private static _getAriaLabel(lang?: string): string {
        ...
        let resx;
        if (lang) {
            resx = SwipeMap._resx[lang.toLowerCase()];
        }
