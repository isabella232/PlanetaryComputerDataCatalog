...
export const makeTileJsonUrl = (
  ...
  if (query.dep) {
    return `https://dep-pctitiler.westeurope.cloudapp.azure.com/mosaicjson/tiles/{z}/{x}/{y}.png?url=${query.mosaicjson}&bidx=1&bidx=2&bidx=3&nodata=0&unscale=false&resampling=nearest&max_size=1024&return_mask=true`
  }
